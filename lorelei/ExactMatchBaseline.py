...
def baselineRWP(records_file, output_file):
    """
    Use this only for condensed-json in RWP-prepped
    :param records_file Must not be indented
    :param output_file
    :return:
    """
    ...
    with codecs.open(records_file, 'r', 'utf-8') as f:
        for line in f:
            obj = json.loads(line)
            if 'situationFrame.entities' not in obj or not obj['situationFrame.entities']:
                # print obj
                continue
            # print obj
            # print obj['situationFrame']['entities']
